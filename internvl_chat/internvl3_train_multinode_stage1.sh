...
this_run="internvl3_chimera_${TIMESTAMP}_${LR}_consolidated_labels-1009-38B-8B"
...
torchrun \
  ...
  --meta_path "./shell/data/train_1007_label_gpt.json" \
  ...
  --max_grad_norm 1.0 \
  --report_to "wandb" \
  --wandb_project "internvl3-consolidated_labels-1009-38B-8B" \
