...
this_run="internvl3_chimera_${TIMESTAMP}_${LR}_0816_label_gpt_bodypart"
...
torchrun \
  ...
  --meta_path "./shell/data/all_0816_label_gpt_bp_only_findings.json" \
  ...
  --max_grad_norm 1.0 \
  --report_to "wandb" \
  --wandb_project "internvl3-all-label-0816" \
