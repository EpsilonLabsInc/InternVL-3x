...
this_run="internvl3_chimera_${TIMESTAMP}_${LR}_0828_label_gpt_bodypart"
...
torchrun \
  ...
  --meta_path "./shell/data/all_0828_label_gpt_bp.json" \
  ...
  --max_grad_norm 1.0 \
  --report_to "wandb" \
  --wandb_project "internvl3-all-label-0828" \
